...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            // navLayout="around"
            className={cn(
                'group/calendar rounded-xl bg-white px-[22px] py-6 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',
